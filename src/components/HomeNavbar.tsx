...
const HomeNavbar = () => {
  ...
  return (
    <nav className="flex justify-center w-full min-h-[15vh] relative ">
      <div className='mix-blend-multiply  w-[90rem] h-[40rem] absolute rounded-full bg-gradient-radial from-main1 via-transparent to-transparent right-[5%] top-[-240%] z-[-1]'></div>
      <div className='mix-blend-multiply  w-[90rem] h-[50rem] absolute rounded-full bg-gradient-radial from-Act7 via-transparent to-transparent  right-[-15%] top-[-290%] z-[-1]'></div>
