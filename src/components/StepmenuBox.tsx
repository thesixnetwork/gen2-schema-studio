...
function StepmenuBox(props: Props) {
  return (
    <Link href={`/newdraft/${props.step}/${props.schemaCode}_v1`}>
      <div className=" w-36 flex justify-start group duration-300 ">
        <div
          className={` w-10 h-16 ${
        ...
        >
          <p
            className={` font-bold ${
              props.currentStep === props.step
                ? " text-white "
                : " text-Act6 font-thin group-hover:text-white group-hover:font-bold duration-500"
            }  text-4xl `}
          >
            {props.step}
          </p>
        ...
        <div className=" flex justify-center items-center">
          <p
            className={`text-Act6 w-20 flex justify-start items-center ml-2 duration-500 ${
              props.currentStep === props.step
                ? " font-bold "
