...
function HomeNewintregationCard({ }: Props) {
    return (
        <div className=' w-56 h-72 border border-dashed rounded-2xl border-Act8 flex flex-col justify-center items-center hover:scale-105 duration-500 cursor-pointer '>
            <div className=' w-10'>
