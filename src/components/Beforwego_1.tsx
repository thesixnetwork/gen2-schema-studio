...
function Beforwego_1(props: MyComponentProps) {
    ...
    return (
        <div onClick={()=>{ props.setParentState1(false)}} className=' fixed top-0 left-0 z-50 w-full h-full bg-black bg-opacity-80  backdrop-blur-sm flex justify-center items-center '>
            ...
            <div className='absolute  bottom-[20vh] left-[40vw]'>
                <div onClick={() => { props.setParentState1(false); props.setParentState2(true) }}>
