...
const ActionCreateCard = () => {
  ...
  return (
    <Link href={`/newdraft/6/${schemacode}/action-form/create-new-action`}>
      <div className="w-96 h-64 min-h-full text-black flex flex-col justify-center items-center border border-dashed border-gray-300 rounded-2xl hover:scale-105 duration-300 gap-y-2">
