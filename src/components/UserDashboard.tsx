  ...
  return (
    <div className=" w-80 h-32 border-2nd4 border rounded-lg justify-between px-3 py-1">
      <div className=" h-[60%]">
        <div className=" h-[50%] flex items-center justify-between">
          <div className=" flex justify-between items-center ">
            ...
            <p className=" ml-3 font-bold text-main2">
      ...
      <div className=" h-[40%] flex items-center justify-between w-full">
        <a
          target="_blank"
          href={`${fiveNet}address/${session?.user?.address}`}
          className=" flex items-center justify-between w-[23%] hover:scale-110 cursor-pointer duration-500"
        >
